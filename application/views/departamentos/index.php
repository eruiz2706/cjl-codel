...
$(document).ready(function(){
    ...
    $("#btn_nuevo").click(function(){
        var base_url = '<?php echo base_url();?>index.php/departamentos/save';
    ...
    $("#modal-default").on("hidden.bs.modal", function () {
        if($('#mrefresh').html()=='1'){
            cargarCapa(base_url+'index.php/departamentos');
        }
    });
    ...
    function openModal(id){
        var base_url = '<?php echo base_url();?>index.php/departamentos/update';
        ...
        $.ajax({
            url : '<?php echo base_url();?>index.php/departamentos/edit/'+id,
