            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="categoria" id="categoria">
                        ...
                        <?php foreach($rescategorias as $rescat){ ?>
...
$(document).ready(function(){
    ...
    $("#btn_nuevo").click(function(){
        var base_url = '<?php echo base_url();?>index.php/subcategorias/save';
    ...
    $("#btn_modal").click(function(){
        $.ajax({
            ...
            success : function(json) {
                ...
                if(json.successmsj){
                    if($("#id").val()==''){
                        $('#categoria').select2().val('').trigger('change');
                        $('#forma').trigger("reset");
                    }
                    $('#mrefresh').html("1");
    ...
    $("#modal-default").on("hidden.bs.modal", function () {
        if($('#mrefresh').html()=='1'){
            cargarCapa(base_url+'index.php/subcategorias');
        }
    });
    ...
    function openModal(id){
        var base_url = '<?php echo base_url();?>index.php/subcategorias/update';
        ...
        $.ajax({
            url : '<?php echo base_url();?>index.php/subcategorias/edit/'+id,
            ...
            success : function(json) {
                if(json != null){
                    ...
                    $('#categoria').select2().val(json.idcatego).trigger('change');
                     console.log(json.idcatego); 
                }
            },beforeSend: function(){
                $("#precargmodal").html("<img src='<?=base_url()?>/assets/dist/img/loader.gif' width='100'></img>");
            },
