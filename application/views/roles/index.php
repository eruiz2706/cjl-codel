    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Alias<font color="red">*</font></label>
            ...
            <thead>
                ...
                <?php foreach($resultado as $res){ ?>
                    <tr>
                        ...
                        <td><?=$res->alias;?></td>
                        <td>
                            <a class='btn btn-primary btn-xs' href="#" onclick="openModal(<?=$res->id;?>);"><i class='fa fa-pencil'></i> Editar</a>
                            <a class='btn btn-primary btn-xs' href="javascript:cargarCapa('<?=base_url();?>index.php/roles/permisos/<?=$res->id;?>');"><i class='fa fa-plus'></i> Permisos</a>
                        </td>    
...
$(document).ready(function(){
    ...
    $("#btn_nuevo").click(function(){
        var base_url = '<?php echo base_url();?>index.php/roles/save';
    ...
    function openModal(id){
        var base_url = '<?php echo base_url();?>index.php/roles/update';
        ...
        $.ajax({
            url : '<?php echo base_url();?>index.php/roles/edit/'+id,
