            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="iddepartamento" id="iddepartamento">
                        <option value=''> - </option>
                        <?php foreach($resultado2 as $resdep){ ?>
...
$(document).ready(function(){
    ...
    $("#btn_nuevo").click(function(){
        var base_url = '<?php echo base_url();?>index.php/municipios/save';
    ...
    $("#modal-default").on("hidden.bs.modal", function () {
        if($('#mrefresh').html()=='1'){
            cargarCapa(base_url+'index.php/municipios');
        }
    });
    ...
    function openModal(id){
        var base_url = '<?php echo base_url();?>index.php/municipios/update';
        ...
        $.ajax({
            url : '<?php echo base_url();?>index.php/municipios/edit/'+id,
