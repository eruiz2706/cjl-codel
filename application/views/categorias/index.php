...
$(document).ready(function(){
    ...
    $("#btn_nuevo").click(function(){
        var base_url = '<?php echo base_url();?>index.php/categorias/save';
    ...
    $("#modal-default").on("hidden.bs.modal", function () {
        if($('#mrefresh').html()=='1'){
            cargarCapa(base_url+'index.php/categorias');
        }
    });
    ...
    function openModal(id){
        var base_url = '<?php echo base_url();?>index.php/categorias/update';
